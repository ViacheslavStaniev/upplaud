...
// Guestii
export const AddGuest = Loadable(lazy(() => import('../pages/dashboard/guestii/AddGuest')));
export const Automations = Loadable(lazy(() => import('../pages/dashboard/guestii/Automations')));
export const AccountAdmin = Loadable(lazy(() => import('../pages/dashboard/guestii/AccountAdmin')));
export const EmailTemplates = Loadable(
  lazy(() => import('../pages/dashboard/guestii/EmailTemplates'))
);
export const GuestingAdmin = Loadable(
  lazy(() => import('../pages/dashboard/guestii/GuestingAdmin'))
);
export const PostingTemplate = Loadable(
  lazy(() => import('../pages/dashboard/guestii/PostingTemplate'))
);
