...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'Add Guest', path: PATH_DASHBOARD.guestii.addGuest, icon: ICONS.addGuest },
      { title: 'Automations', path: PATH_DASHBOARD.guestii.automations, icon: ICONS.automations },
      {
  ...
  // DEMO MENU STATES
  {
    ...
    items: [
...

      {
        ...
        icon: ICONS.label,
        info: (
          <Label variant="ghost" startIcon={<Iconify icon="eva:email-fill" />}>
            NEW
          </Label>
        ),
      },
