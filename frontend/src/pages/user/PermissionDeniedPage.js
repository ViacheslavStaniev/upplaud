...
export default function PermissionDeniedPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Other Cases: Permission Denied | Podasq</title>
      </Helmet>
            ...
            {[...Array(8)].map((_, index) => (
              <Card key={index}>
                ...
                <Typography sx={{ p: 3, color: 'text.secondary' }}>
                  Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. In enim justo, rhoncus ut, imperdiet a, venenatis
