  ...
  return (
    <>
      ...
      <div className='email-template'>
        <Title className='m-0 mb-1'>Email Template</Title>

        <Paragraph className='mb-4'>
          <AppTitle appNameOnly /> can invite your guests to connect their social media to automatically promote their upcoming episode
          and collect questions from their connections. Often, reminders are helpful. You can manually remind & invite your guests
          through the Automations dashboard. Below, you can edit the 3 successive emails that <AppTitle appNameOnly /> can
          automatically send to your guests.
        </Paragraph>
          ...
          >
            {invitations.map(({ key, header, initialValues }) => (
              <Panel header={header} key={key}>
                <Form name={`form_${key}`} size='large' layout='vertical' onFinish={console.log} initialValues={initialValues}>
